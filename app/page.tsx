...
const membersData: Record<MemberKey, Member> = {
  towako: {
    ...
    portraitLabel: 'Cello resonance portrait placeholder',
  },
  ren: {
    name: '鳩咲 蓮',
    ...
    portraitLabel: 'Piano atmosphere portrait placeholder',
  },
};
...
export default function HatoRenoir() {
        ...
        <div className="relative">
          <header className="border-b border-amber-900/30">
            <div className="mx-auto max-w-7xl px-6 py-10 sm:px-8">
              <p className="text-xs uppercase tracking-[0.48em] text-gray-500">echoes of emotion</p>
              <h1 className="mt-3 text-4xl font-light tracking-[0.28em] sm:text-5xl" style={{ color: '#C9A961' }}>
                HATO RENOIR
              </h1>
            </div>
          </header>
          ...
          <section className="border-b border-amber-900/30">
            <div className="mx-auto grid max-w-7xl gap-12 px-6 py-14 sm:px-8 md:grid-cols-[1.05fr_1fr] md:py-18">
              <div className="space-y-6">
                <div className="flex h-96 items-end rounded-sm border border-amber-900/30 bg-[linear-gradient(160deg,rgba(245,245,220,0.12),rgba(201,169,97,0.04)_38%,rgba(10,10,10,0.94)_100%)] p-8">
                  <div className="space-y-6">
                    <div
                      className="inline-flex h-16 w-16 items-center justify-center rounded-full border border-current text-lg tracking-[0.34em] text-white/90"
                      style={{ color: member.color }}
                    >
                      {activeMember === 'towako' ? 'TW' : 'RN'}
                    </div>
                    <div>
                      <p className="text-xs uppercase tracking-[0.35em] text-gray-500">Portrait Placeholder</p>
                      <p className="mt-3 max-w-sm text-sm leading-7 text-gray-300">{member.portraitLabel}</p>
                    </div>
                  </div>
                </div>
          ...
          <footer className="py-12">
            <div className="mx-auto max-w-7xl px-6 text-center sm:px-8">
              <p className="text-xs uppercase tracking-[0.28em] text-gray-600">© 2026 HATO RENOIR. All rights reserved.</p>
              <p className="mt-4 text-sm text-gray-500">「沈黙も音楽。」</p>
            </div>
          </footer>
        </div>
      </div>
